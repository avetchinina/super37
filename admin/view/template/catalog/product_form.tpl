    ...
    <div class="table-responsive">
        <table id="images" class="table table-striped table-bordered table-hover">
            ...
            <tr id="image-row<?php echo $image_row; ?>">
                ...
                <td class="text-right"><input type="text" name="product_image[<?php echo $image_row; ?>][color_name]" value="<?php echo $product_image['color_name']; ?>" placeholder="<?php echo $entry_color_name; ?>" class="form-control" /></td>
...
<script type="text/javascript"><!--
    ...
    function addImage() {
        ...
        html += '<td class="text-right"><input type="text" name="product_image[' + image_row + '][color_name]" value="" placeholder="<?php echo $entry_color_name; ?>" class="form-control" /></td>';

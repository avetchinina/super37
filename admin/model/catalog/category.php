...
class ModelCatalogCategory extends Model {
	...
	public function getTotalCategoriesByLayoutId($layout_id) {
        ...
        public function updateCategoryIncrement($category_id, $value) {
            $this->db->query("UPDATE " . DB_PREFIX . "category_description SET increment_value = '" . ++$value . "' WHERE category_id = '" . (int)$category_id . "'");
